...
namespace Home5
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Student[] Group1 = Student.GenerateStudentsArray(5, nameof(Group1));
            Student[] Group2 = Student.GenerateStudentsArray(5, nameof(Group2));
            Student[] Group3 = Student.GenerateStudentsArray(5, nameof(Group3));
            ...
            {
                student.SetReward(random.Next(0,Constants.maxReward));
            }
